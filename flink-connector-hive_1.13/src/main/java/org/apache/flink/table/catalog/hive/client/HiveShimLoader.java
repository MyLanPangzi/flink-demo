...
public class HiveShimLoader {
    ...
    public static final String HIVE_VERSION_V2_3_9_AMZN_0 = "2.3.9-amzn-0";
    private static final String HIVE_VERSION_V2_3_9 = "2.3.9";
    ...
    public static HiveShim loadHiveShim(String version) {
        return hiveShims.computeIfAbsent(
                ...
                (v) -> {
                    ...
                    if (v.startsWith(HIVE_VERSION_V2_3_9_AMZN_0)) {
                        return new HiveShimV239Amzn0();
                    }
